...
class QueryProcessingException(TException):
    ...
    def __init__(self, reason=None, queryId=None,):
        super(QueryProcessingException, self).__setattr__('reason', reason)
        super(QueryProcessingException, self).__setattr__('queryId', queryId)
    ...
    def __hash__(self):
        return hash(self.__class__) ^ hash((self.reason, self.queryId, ))
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    queryId = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
