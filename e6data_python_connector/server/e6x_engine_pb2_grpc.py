...
class QueryEngineServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.executeDataFrame = channel.unary_unary(
                ...
                _registered_method=True)
        self.executeMLPipeline = channel.unary_unary(
...
class QueryEngineServiceServicer(object):
    ...
    def executeMLPipeline(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_QueryEngineServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'executeMLPipeline': grpc.unary_unary_rpc_method_handler(
