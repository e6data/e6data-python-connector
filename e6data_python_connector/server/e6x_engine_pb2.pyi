...
class PrepareStatementResponse(_message.Message):
    __slots__ = ("engineIP", "queryId", "sessionId")
    ...
    queryId: str
    sessionId: str
    def __init__(self, engineIP: _Optional[str] = ..., queryId: _Optional[str] = ..., sessionId: _Optional[str] = ...) -> None: ...
...
class GetResultMetadataResponse(_message.Message):
    __slots__ = ("resultMetaData", "sessionId")
    RESULTMETADATA_FIELD_NUMBER: _ClassVar[int]
    SESSIONID_FIELD_NUMBER: _ClassVar[int]
    resultMetaData: bytes
    sessionId: str
    def __init__(self, resultMetaData: _Optional[bytes] = ..., sessionId: _Optional[str] = ...) -> None: ...
...
class GetNextResultBatchResponse(_message.Message):
    __slots__ = ("resultBatch", "sessionId")
    RESULTBATCH_FIELD_NUMBER: _ClassVar[int]
    SESSIONID_FIELD_NUMBER: _ClassVar[int]
    resultBatch: bytes
    sessionId: str
    def __init__(self, resultBatch: _Optional[bytes] = ..., sessionId: _Optional[str] = ...) -> None: ...
...
class ExplainAnalyzeResponse(_message.Message):
    __slots__ = ("explainAnalyze", "isCached", "parsingTime", "queueingTime", "sessionId")
    ...
    queueingTime: int
    sessionId: str
    def __init__(self, explainAnalyze: _Optional[str] = ..., isCached: bool = ..., parsingTime: _Optional[int] = ..., queueingTime: _Optional[int] = ..., sessionId: _Optional[str] = ...) -> None: ...
...
class ExplainResponse(_message.Message):
    __slots__ = ("explain", "sessionId")
    EXPLAIN_FIELD_NUMBER: _ClassVar[int]
    SESSIONID_FIELD_NUMBER: _ClassVar[int]
    explain: str
    sessionId: str
    def __init__(self, explain: _Optional[str] = ..., sessionId: _Optional[str] = ...) -> None: ...
...
class StatusResponse(_message.Message):
    __slots__ = ("status", "rowCount", "sessionId")
    ...
    rowCount: int
    sessionId: str
    def __init__(self, status: bool = ..., rowCount: _Optional[int] = ..., sessionId: _Optional[str] = ...) -> None: ...
...
class GetSchemaNamesResponse(_message.Message):
    __slots__ = ("schemas", "sessionId")
    SCHEMAS_FIELD_NUMBER: _ClassVar[int]
    SESSIONID_FIELD_NUMBER: _ClassVar[int]
    schemas: _containers.RepeatedScalarFieldContainer[str]
    sessionId: str
    def __init__(self, schemas: _Optional[_Iterable[str]] = ..., sessionId: _Optional[str] = ...) -> None: ...
...
class GetTablesResponse(_message.Message):
    __slots__ = ("tables", "sessionId")
    TABLES_FIELD_NUMBER: _ClassVar[int]
    SESSIONID_FIELD_NUMBER: _ClassVar[int]
    tables: _containers.RepeatedScalarFieldContainer[str]
    sessionId: str
    def __init__(self, tables: _Optional[_Iterable[str]] = ..., sessionId: _Optional[str] = ...) -> None: ...
...
class GetColumnsResponse(_message.Message):
    __slots__ = ("fieldInfo", "sessionId")
    FIELDINFO_FIELD_NUMBER: _ClassVar[int]
    SESSIONID_FIELD_NUMBER: _ClassVar[int]
    fieldInfo: _containers.RepeatedCompositeFieldContainer[GFieldInfo]
    sessionId: str
    def __init__(self, fieldInfo: _Optional[_Iterable[_Union[GFieldInfo, _Mapping]]] = ..., sessionId: _Optional[str] = ...) -> None: ...
